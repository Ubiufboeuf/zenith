...
export function Button ({ children, id, title, label, color, size, fill, shape, width, selected, disabled, focusable = true, tabIndex, class: className = '', onClick, style }: ButtonProps) {
