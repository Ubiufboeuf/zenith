...
export function Result ({ name, code, category, prices, priceId, stock }: Product) {
  ...
  return (
    ...
    >
      ...
      <h1 title={name} class='col-span-full xs:col-[2/5] row-2 xs:row-1 line-clamp-2 xs:line-clamp-1 text-start font-medium text-light'>{capitalize(capitalize(name, '('), ' ')}</h1>
