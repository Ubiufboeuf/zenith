...
export function SidebarUserCard () {
  return (
    <footer class='h-full w-full grid grid-cols-[1fr_36px] items-center gap-2 px-2 border-t border-border'>
      <button class='h-12 w-full flex items-center justify-start gap-3 px-1 *:text-start rounded-lg cursor-pointer transition-colors hover:bg-accent'>
      ...
      <button class='group size-9 flex items-center justify-center rounded-lg ml-auto cursor-pointer transition-colors hover:bg-accent'>
        <Icon class='size-4 stroke-2 text-neutral-400 group-hover:text-light'>
          <IconExit />
        </Icon>
      </button>
    </footer>
